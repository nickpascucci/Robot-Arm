...
from brazo_lib.PreferencesDialog import PreferencesDialog

class PreferencesBrazoDialog(PreferencesDialog):
    __gtype_name__ = "PreferencesBrazoDialog"

    def finish_initializing(self, builder): # pylint: disable=E1002
        """Set up the preferences dialog"""
        super(PreferencesBrazoDialog, self).finish_initializing(builder)
