...
class PreferencesDialog(gtk.Dialog):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('PreferencesBrazoDialog')
        new_object = builder.get_object("preferences_brazo_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        finish initializing the start of the new PerferencesBrazoDialog
        instance.
