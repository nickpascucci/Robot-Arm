...
import gtk
import logging
logger = logging.getLogger('brazo_lib')

from . helpers import get_builder, show_uri, get_help_uri
from . preferences import preferences

# This class is meant to be subclassed by BrazoWindow.  It provides
...
class Window(gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseBrazoWindow object.
        """
        builder = get_builder('BrazoWindow')
        new_object = builder.get_object("brazo_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a BrazoWindow object with it in order to finish
        initializing the start of the new BrazoWindow instance.
        """
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for brazo."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for brazo."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the BrazoWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the BrazoWindow is closed."""
